        ...
        <>
            <div id="container" ref={ domRef } className={ `fade-in-section ${ isVisible ? 'is-visible' : '' }` }>
                ...
                <ul>
                    ...
                    <li className="course-name">This project is ongoing - the project GitHub repository is <a href="https://github.com/archishmagoli/QuakeCaster">here!</a></li>
                </ul>
                ...
                <div className="general-text">
                    <ul>
                        ...
                        <li className="course-name">This project is ongoing - the project GitHub repository is <a href="https://github.com/archishmagoli/Isolation_RL">here!</a></li>
                    </ul>
                </div>
